...
#SBATCH --ntasks=112                  #will request 112 cores across multiple nodes
...
script=/shared/centos7/spark/2.3.2-hadoop2.7/examples/src/main/python/mllib/correlations.py
data=/shared/centos7/spark/2.3.2-hadoop2.7/data/mllib/sample_linear_regression_data.txt

        # check what time it is before the job starts
        STARTT=`date +%s`

        spark-submit --master $MASTER --total-executor-cores $SLURM_NTASKS $script $data
